...
/**
 * @file
 * Contains \Drupal\page_manager_content_type\Form\LayoutContentTypeEdit.
 */
...
class LayoutContentTypeEdit extends LayoutContentTypeBase {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $entity_bundle = $this->entity->get('entity_bundle');
    $entity_view_mode =  $this->entity->get('entity_view_mode');
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirect('page_manager_content_type.page_list');
  }
}